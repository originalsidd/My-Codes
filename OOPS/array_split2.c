/*WAP to display date of format dd-month_name-yyyy and dd/month_name_short/yyyy and mm/dd/yyyy in the final format dd/mm/yyyy*/
...
void output(char** arr,int *f,int *t){
    printf("In dd/mm/yyyy format for date %d: ",*t);
    if (*f==1 || *f==2){
        int mm;
        mm=mon(arr[1]);
        printf("%s/%d/%s\n",arr[0],mm,arr[2]);
